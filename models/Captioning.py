...
class Captioning(object):
    ...
    def build_graph(self):
        ...
        rnn1_output, _ = tf.nn.dynamic_rnn(self.rnn_cell1, inputs=word_embed, initial_state=tf.nn.rnn_cell.LSTMStateTuple(initial_state, initial_state))
        ...
        state = tf.nn.rnn_cell.LSTMStateTuple(initial_state, initial_state)
